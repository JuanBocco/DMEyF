...
getwd()
setwd("/Users/angus/Desktop/Maestria/DM_EyF/DMEyF/Competencia Final")
...
PARAM  <- list()
PARAM$experimento <- "TS9320_FINAL"

PARAM$exp_input  <- "FE9250_FINAL"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201902, 201903,201904,201905,201906,201907,201908,201909,201910,201911,201912, 202001,202002, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105,202106,202107)


PARAM$train$training     <- c( 201902, 201903,201904,201905,201906,201907,201908,201909,201910,201911,201912, 202001,202002, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
PARAM$train$semilla_sampling  <- 888809
PARAM$train$semilla_under     <- 888809
