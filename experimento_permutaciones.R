...
# Abro el dataset de julio previamente armado
julio <- fread('/Users/angus/Desktop/Maestria/DM_EyF/DMEyF/datasets/competenciaFINAL_202107.csv.gz')
...
dir.create(paste0('/Users/angus/Desktop/Maestria/DM_EyF/DMEyF/ZZ9410_semillerio'), showWarnings = FALSE)
...
path_experimento_semillerio <- paste0('/Users/angus/Desktop/Maestria/DM_EyF/DMEyF/datasets/', PARAM$exp_input)
